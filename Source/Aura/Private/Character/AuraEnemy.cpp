...
void AAuraEnemy::BindTagsCallbacks()
{
...
void AAuraEnemy::HighlightActor()
{
	...
	GetMesh()->SetCustomDepthStencilValue(HighlightDepthStencilValue);
	Weapon->SetRenderCustomDepth(true);
	Weapon->SetCustomDepthStencilValue(HighlightDepthStencilValue);
}
