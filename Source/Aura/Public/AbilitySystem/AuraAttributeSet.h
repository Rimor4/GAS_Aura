...
#pragma region Secondary Attributes
	...
	// 暴击伤害（百分比）
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_CritDamageMultiplier, Category = "Secondary Attributes")
	FGameplayAttributeData CritDamageMultiplier;
	ATTRIBUTE_ACCESSORS(UAuraAttributeSet, CritDamageMultiplier);
